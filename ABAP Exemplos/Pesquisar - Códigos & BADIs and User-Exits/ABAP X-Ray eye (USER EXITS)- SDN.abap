...
tables: sxs_attr,             "Exit: lado de definição: atributos de uma ampliação
        tobjt,                "Textos breves para objetos de autorização
        tstct,                "Textos de código de transação"TCode texts
        trdirt,              " Textos título p/programas em TRDIR"Program texts
        sxc_exit.            " Exit: lado de implementação: atribuição: exit - implement. "BADI exits

type-pools: slis.            "Globale Typen fÃ¼r generische Listbausteine
...
* Source code
types: begin of t_sourcetab,                       "#EC * (SLIN lÃ¼gt!)
        line(200),                                 "#EC * (SLIN lÃ¼gt!)
      end of t_sourcetab.                          "#EC * (SLIN lÃ¼gt!)
